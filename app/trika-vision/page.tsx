...
export default function TrikaVisionPage() {
  ...
  useEffect(() => {
    ...
    const type = urlParams.get("workout")
    if (type) {
      setWorkoutType(type)
    }
  }, [])
    ...
    <div className="fixed inset-0 bg-black z-50">
      <div
        className={`bg-white transition-all duration-300 ${
          isMinimized ? "fixed top-4 right-4 w-96 h-64 rounded-2xl shadow-2xl z-[60]" : "w-full h-full"
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-blue-50 to-indigo-50 flex-shrink-0">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" onClick={handleExit} className="hover:bg-blue-100">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">TrikaVision</h2>
              <p className="text-blue-600 font-medium text-sm">AI-Powered Form Analysis</p>
            </div>
          </div>
        ...
        {!isMinimized && (
          <div className="flex-1 flex overflow-hidden">
            ...
            {/* Stats Panel */}
            <div className="w-96 bg-gradient-to-b from-blue-50 to-indigo-50 border-l border-blue-200 flex flex-col max-h-full">
        ...
        {isMinimized && (
          <div className="flex-1 p-4 flex flex-col justify-center">
            <div className="text-center space-y-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-sm">{workoutType}</h3>
              ...
              {(isRecording || sessionTime > 0) && (
                <div className="space-y-1">
                  <p className="font-mono text-sm font-bold text-blue-600">{formatTime(sessionTime)}</p>
                  <p className="text-xs text-gray-600">
